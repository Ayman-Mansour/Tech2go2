...
public class RVArrayAdapter_Sub_Systems extends RecyclerView.Adapter<RVArrayAdapter_Sub_Systems.MyViewHolder> {
    private LayoutInflater inflater;
    private List<Information> data = Collections.emptyList();
    private final static int FADE_DURATION = 1000; // in milliseconds
    private Context context;

    public RVArrayAdapter_Sub_Systems(Context context, List<Information> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = inflater.inflate(R.layout.custom_systems_list, viewGroup, false);
